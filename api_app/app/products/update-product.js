$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("http://localhost/traineeship/week12/api_app/api/product/read_one.php?id=" + id, function(data){
            ...
            $.getJSON("http://localhost/traineeship/week12/api_app/api/category/read.php", function(data){
    ...
    $(document).on('submit', '#update-product-form', function(){
        ...
        $.ajax({
            url: "http://localhost/traineeship/week12/api_app/api/product/update.php",
            type : "POST",
