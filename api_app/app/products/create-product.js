$(document).ready(function(){
    ...
    $(document).on('click', '.create-product-button', function(){
        ...
        $.getJSON("http://localhost/traineeship/week12/api_app/api/product/read.php", function(data){
    ...
    $(document).on('submit', '#create-product-form', function(){
        ...
        $.ajax({
            url: "http://localhost/traineeship/week12/api_app/api/product/create.php",
            type : "POST",
